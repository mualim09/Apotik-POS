		...
		<tr>
			<td colspan=4>
				<div class="input-group">
					...
					<input class='form-control form-control-sm' placeholder="NOTA" required type="text"  name="nota" value="" />
					<input  required class='form-control form-control-sm' placeholder='Supplier' type="text" name="supplier" id="j" value="" />
		...
		<tr>
			<td colspan=4>
				<div class="input-group">
					...
					<input required class='form-control form-control-sm  col-sm-2 b1' placeholder='Kategori' type="text" name="kategori" id="kategori" value="" />
		...
		$("#nama").on('keypress',function(e){
			...
			$("#xsimpan").on('submit',function(e){
				...
				e.preventDefault();
					...
					//		$("#divpopup").load("pembelian/sn/<?php echo $nobil; ?>/"+kode);
						},
						error: function(dt){
